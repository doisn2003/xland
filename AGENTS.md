...
- Theo yêu cầu mới nhất 25/09/2026: kết hợp ảnh chụp thật có nguồn/quyền sử dụng với ảnh ảo/phối cảnh đẹp. UI dùng ngôn ngữ sản phẩm, không phủ nhãn demo, dữ liệu mẫu hoặc hình ảnh minh họa. Ghi phân loại, nguồn và giới hạn trong `docs/ASSETS.md`; không gán media thành bằng chứng đã xác minh tài sản.
